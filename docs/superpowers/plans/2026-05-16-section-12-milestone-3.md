...
- [ ] **Step 1: Set session title to `section12-milestone3`**
...
- [ ] **Step 2: Confirm session title shows `section12-milestone3` in the UI**

If your CLI shows the session title in its title bar or tab, verify it reads `section12-milestone3`.
...
The file content should be a ready-to-paste prompt for starting M4 in a fresh Claude Code session:
...
- Confirmed `git log` shows M3 commits cleanly merged on main
...
```bash
git add docs/superpowers/starter-prompts/section-12-m4-starter.md
