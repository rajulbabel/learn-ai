...
- [ ] **Step 1: Set session title to `section12-milestone4`**
...
- [ ] **Step 2: Confirm session title shows `section12-milestone4` in the UI**

If your CLI shows the session title in its title bar or tab, verify it reads `section12-milestone4`.
...
The file content should be a ready-to-paste prompt for starting M5 in a fresh Claude Code session:
...
- Confirmed `git log` shows M4 commits cleanly merged on main
...
```bash
git add docs/superpowers/starter-prompts/section-12-m5-starter.md
