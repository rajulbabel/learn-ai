        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 0, width: "100%" }}>
          {[
            ...
            <div key={f} style={{ display: "flex", flexDirection: "column", alignItems: "center", width: "100%" }}>
              {idx > 0 && <div style={{ width: 0, height: 0, borderLeft: "6px solid transparent", borderRight: "6px solid transparent", borderTop: `10px solid ${C.dim}`, marginTop: 6, marginBottom: 6 }} />}
              <div style={{ padding: "12px 14px", borderRadius: 10, background: `${c}08`, border: `1px solid ${c}18`, width: "100%", display: "flex", flexDirection: "column", gap: 6 }}>
                <code style={{ color: c, fontWeight: 800, fontSize: 22, textAlign: "center", padding: "6px 10px", background: `${c}12`, borderRadius: 8, display: "block" }}>{f}</code>
                <div>
                  <T color={C.mid} size={16}>{m}</T>
                  <T color={c} size={15} bold>→ {r}</T>
                </div>
              </div>
            </div>
          ))}
