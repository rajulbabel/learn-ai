...
export const Ch3_1 = (ctx) => { const { sub, subBtnRipple, setSubBtnRipple, navigate, bankIdx, setBankIdx, hovered, setHovered } = ctx; return (
...
// ═══════ CH 1: The Problem ═══════
export const Ch3_2 = (ctx) => { const { sub, subBtnRipple, setSubBtnRipple, navigate, bankIdx, setBankIdx, hovered, setHovered } = ctx;
  const sentences = [
...
export const Ch3_3 = (ctx) => { const { sub, subBtnRipple, setSubBtnRipple, navigate, bankIdx, setBankIdx, hovered, setHovered } = ctx;
...
// ═══════ CH 3: Dot Product ═══════
export const Ch3_4 = (ctx) => { const { sub, subBtnRipple, setSubBtnRipple, navigate, bankIdx, setBankIdx, hovered, setHovered } = ctx; return (
  <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
    {sub >= 0 && (
...
export const Ch3_5 = (ctx) => { const { sub, subBtnRipple, setSubBtnRipple, navigate, bankIdx, setBankIdx, hovered, setHovered } = ctx; return (
  <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
    {sub >= 0 && (
...
export const Ch3_6 = (ctx) => { const { sub, subBtnRipple, setSubBtnRipple, navigate, bankIdx, setBankIdx, hovered, setHovered } = ctx; return (
  <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
    {sub >= 0 && (
      <Box color={C.purple} style={{ width: "100%" }}>
...
export const Ch3_7 = (ctx) => { const { sub, subBtnRipple, setSubBtnRipple, navigate, bankIdx, setBankIdx, hovered, setHovered } = ctx; return (
  <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
    {sub >= 0 && (
...
export const Ch3_8 = (ctx) => { const { sub, subBtnRipple, setSubBtnRipple, navigate, bankIdx, setBankIdx, hovered, setHovered } = ctx; return (
  <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
    {sub >= 0 && (
      <Box color={C.orange} style={{ width: "100%" }}>
...
export const Ch3_9 = (ctx) => { const { sub, subBtnRipple, setSubBtnRipple, navigate, bankIdx, setBankIdx, hovered, setHovered } = ctx; return (
  <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
    {sub >= 0 && (
      <Box color={C.purple} style={{ width: "100%" }}>
...
export const Ch3_10 = (ctx) => { const { sub, subBtnRipple, setSubBtnRipple, navigate, bankIdx, setBankIdx, hovered, setHovered } = ctx; return (
  <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
    {sub >= 0 && (
      <Box color={C.orange} style={{ width: "100%" }}>
...
export const Ch3_11 = (ctx) => { const { sub, subBtnRipple, setSubBtnRipple, navigate, bankIdx, setBankIdx, hovered, setHovered } = ctx; return (
  <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
    {sub >= 0 && (
...
export const Ch3_12 = (ctx) => { const { sub, subBtnRipple, setSubBtnRipple, navigate, bankIdx, setBankIdx, hovered, setHovered } = ctx; return (
  <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
    {sub >= 0 && (
      <Box color={C.orange} style={{ width: "100%" }}>
...
export const Ch3_13 = (ctx) => { const { sub, subBtnRipple, setSubBtnRipple, navigate, bankIdx, setBankIdx, hovered, setHovered } = ctx; return (
  <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
    {sub >= 0 && (
      <Box color={C.cyan} style={{ width: "100%" }}>
...
export const Ch3_14 = (ctx) => { const { sub, subBtnRipple, setSubBtnRipple, navigate, bankIdx, setBankIdx, hovered, setHovered } = ctx; return (
  <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
    {sub >= 0 && (
...
export const Ch3_16 = (ctx) => { const { sub, subBtnRipple, setSubBtnRipple, navigate, bankIdx, setBankIdx, hovered, setHovered } = ctx; return (
  <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
...
export const Ch3_15 = (ctx) => { const { sub, subBtnRipple, setSubBtnRipple, navigate, bankIdx, setBankIdx, hovered, setHovered } = ctx; return (
  <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
...
export const Ch3_17 = (ctx) => { const { sub, subBtnRipple, setSubBtnRipple, navigate, bankIdx, setBankIdx, hovered, setHovered } = ctx; return (
  <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
    {sub >= 0 && (
      <Box color={C.pink} style={{ width: "100%" }}>
...
export const Ch3_18 = (ctx) => { const { sub, subBtnRipple, setSubBtnRipple, navigate, bankIdx, setBankIdx, hovered, setHovered } = ctx; return (
  <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
    {sub >= 0 && (
...
export const Ch3_19 = (ctx) => { const { sub, subBtnRipple, setSubBtnRipple, navigate, bankIdx, setBankIdx, hovered, setHovered } = ctx; return (
  <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
    {sub >= 0 && (
...
export const Ch3_20 = (ctx) => { const { sub, subBtnRipple, setSubBtnRipple, navigate, bankIdx, setBankIdx, hovered, setHovered } = ctx; return (
  <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
    {sub >= 0 && (
      <Box color={C.red} style={{ width: "100%" }}>
...
// ═══════ CH 19: The Split ═══════
export const Ch3_21 = (ctx) => { const { sub, subBtnRipple, setSubBtnRipple, navigate, bankIdx, setBankIdx, hovered, setHovered } = ctx; return (
  <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
    {sub >= 0 && (
      <Box color={C.purple} style={{ width: "100%" }}>
...
export const Ch3_22 = (ctx) => { const { sub, subBtnRipple, setSubBtnRipple, navigate, bankIdx, setBankIdx, hovered, setHovered } = ctx; return (
  <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
    {sub >= 0 && (
      <Box color={C.blue} style={{ width: "100%" }}>
...
// ═══════ CH 21: Concat + W_O ═══════
export const Ch3_23 = (ctx) => { const { sub, subBtnRipple, setSubBtnRipple, navigate, bankIdx, setBankIdx, hovered, setHovered } = ctx; return (
  <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
...
export const Ch3_24 = (ctx) => { const { sub, subBtnRipple, setSubBtnRipple, navigate, bankIdx, setBankIdx, hovered, setHovered } = ctx; return (
  <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
    {sub >= 0 && (
      <Box color={C.orange} style={{ width: "100%" }}>
...
export const Ch3_25 = (ctx) => { const { sub, subBtnRipple, setSubBtnRipple, navigate, bankIdx, setBankIdx, hovered, setHovered } = ctx; return (
  <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
    {sub >= 0 && (
      <Box color={C.purple} style={{ width: "100%" }}>
...
export const Ch3_26 = (ctx) => { const { sub, subBtnRipple, setSubBtnRipple, navigate, bankIdx, setBankIdx, hovered, setHovered } = ctx; return (
  <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
    {sub >= 0 && (
      <Box color={C.green} style={{ width: "100%" }}>
...
export const Ch3_27 = (ctx) => { const { sub, subBtnRipple, setSubBtnRipple, navigate } = ctx; return (
  <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
