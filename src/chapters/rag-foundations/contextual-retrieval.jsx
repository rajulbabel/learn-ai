...
const CONTEXTUAL_STACK_STEPS = [
  ...
  },
  {
    ...
    accent: "#80deea",
    recap: "Hybrid - covered in Section 17.5 - merges semantic and lexical recall.",
  },
  {
    color: C.orange,
    ...
    accent: "#ffcc80",
    recap: "Rerankers - covered in Section 17.6 - cross-encoder scores each query-chunk pair.",
  },
];
