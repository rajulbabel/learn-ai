...
export const sections = [
  ...
  },
  {
    ...
    chapters: [
      ...
      {
        slug: "road-to-transformers/rnn-flaws",
  ...
  },
  {
    ...
    chapters: [
      ...
      {
        slug: "transformer-input/embeddings",
  ...
  },
  {
    ...
    chapters: [
      ...
      {
        slug: "vector-foundations/hnsw-search",
      ...
      {
        slug: "vector-foundations/vamana",
  ...
  },
  {
    ...
    chapters: [
      ...
      {
        slug: "vector-compression/hnsw-pq",
  ...
  },
  {
    ...
    chapters: [
      {
        slug: "vector-production/filtering",
      ...
      {
        slug: "vector-production/rerankers",
  ...
  },
  {
    ...
    chapters: [
      ...
      {
        slug: "rag-evaluation/llm-as-judge",
        file: "rag-evaluation/llm-as-judge",
        title: "LLM-as-Judge",
        component: "LLMAsJudge",
      },
      {
        slug: "rag-evaluation/ragas-metrics",
      ...
      {
        slug: "rag-production/cost-models",
  ...
  },
  {
    ...
    chapters: [
      ...
      {
        slug: "agent-tools/why-protocols",
  ...
  },
  {
    ...
    chapters: [
      ...
      {
        slug: "agent-loops/agent-loop",
        file: "agent-loops/agent-loop",
        title: "The Agent Loop",
        component: "AgentLoop",
      },
      {
        slug: "agent-loops/re-act-pattern",
  ...
  },
  {
    ...
    chapters: [
      ...
      {
        slug: "multi-agent/agent-handoffs",
  ...
  },
  {
    ...
    chapters: [
      ...
      {
        slug: "agent-evals/llm-as-judge",
        file: "agent-evals/llm-as-judge",
        title: "LLM-as-Judge",
        component: "LlmAsJudge",
      },
      {
        slug: "agent-evals/trace-evals",
      ...
      {
        slug: "agent-production/cost-control",
      ...
      {
        slug: "agent-production/guardrails",
