...
// Context-window budget zones (128k frontier model). Order matches assembly stack top-to-bottom.
...
// Prompt-assembly stack (top to bottom = order the model reads them).
...
// Three strategies for the same 128k budget. Each entry sums to 128 (k tokens).
...
// U-shape recall sampling. Position 0 = top of context, position 1 = bottom (near query).
// Recall is highest at edges, lowest in the middle. Used for the SVG curve.
...
// Relevance-first vs recency-first ordering.
...
// Eviction ladder. evictRank=1 means evict first (cheapest loss). evictRank=6 means evict last (never).
