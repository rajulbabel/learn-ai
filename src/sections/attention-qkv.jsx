...
export const ContextProblem = (ctx) => {
...
export const WhyNotDirectDot = (ctx) => {
  const { sub, subBtnRipple, setSubBtnRipple, registerSubBtn, navigate } = ctx;
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
      {sub >= 0 && (
...
export const AskerAnswerer = (ctx) => {
  const { sub, subBtnRipple, setSubBtnRipple, registerSubBtn, navigate } = ctx;
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
      {sub >= 0 && (
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
            {[
              ...
              <div
                key={name}
                style={{ display: "grid", gridTemplateColumns: "44px 1fr 1fr 1fr", gap: 6, alignItems: "center" }}
              >
...
export const WhyKVDifferent = (ctx) => {
  const { sub, subBtnRipple, setSubBtnRipple, registerSubBtn, navigate } = ctx;
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
      {sub >= 0 && (
...
export const GoogleAnalogy = (ctx) => {
  const { sub, subBtnRipple, setSubBtnRipple, registerSubBtn, navigate } = ctx;
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
      {sub >= 0 && (
...
export const HowQKVCreated = (ctx) => {
  const { sub, subBtnRipple, setSubBtnRipple, registerSubBtn, navigate } = ctx;
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
      {sub >= 0 && (
    ...
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
      ...
      <Reveal when={sub >= 3}>
        <Box color={C.purple} style={{ width: "100%" }}>
          ...
          <T color="#b8a9ff" style={{ marginTop: 6 }}>
            Let's look at a single number in W_Q - say row 2, column 3:
          </T>
        ...
        <Box color={C.cyan} style={{ width: "100%" }}>
          ...
          >
            ...
            <T color={C.mid} size={16} center style={{ marginTop: 6 }}>
              No human sat down and said "row 2, column 3 should be 0.14." The numbers <strong>emerged</strong> from the
...
export const TracingExample = (ctx) => {
  const { sub, subBtnRipple, setSubBtnRipple, registerSubBtn, navigate } = ctx;
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
      {sub >= 0 && (
