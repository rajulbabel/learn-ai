    ...
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
      {sub >= 0 && (
        <Box color={C.red} style={{ width: "100%" }}>
          ...
          <T color="#ef9a9a" size={17} style={{ marginTop: 12 }}>
            Gradient descent from chapter 1.12 uses the same learning rate for every parameter. But different parameters
          ...
          <T color="#ef9a9a" size={16} style={{ marginTop: 14 }}>
            Parameter A gets a 1500x bigger step than Parameter B. SGD treats them identically - the only difference is
            the raw gradient magnitude. We need something smarter.
          </T>
        </Box>
      )}
      ...
      <Reveal when={sub >= 1}>
        <Box color={C.blue} style={{ width: "100%" }}>
          ...
          <T color="#5eb3ff" size={17} style={{ marginTop: 12 }}>
            Instead of using only the current gradient, keep a running average. This smooths out noise and builds speed
          ...
          >
            <T color={C.blue} bold size={17} style={{ fontFamily: "monospace" }}>
              m_t = 0.9 x m_(t-1) + 0.1 x g_t
            </T>
          </div>
          <T color="#5eb3ff" size={15} style={{ marginTop: 8 }}>
            Where beta_1 = 0.9 (weight on history) and g_t is the current gradient.
          </T>
          <T color="#5eb3ff" bold size={16} style={{ marginTop: 14 }}>
            Concrete example with 3 steps:
          </T>
          ...
          <T color="#5eb3ff" size={16} style={{ marginTop: 12 }}>
            Notice how momentum smooths the zigzag. Even though gradients flip between -2, +3, -1, the momentum stays
            close to zero - correctly indicating no strong net direction. Like a ball rolling downhill: it accumulates
            speed in consistent directions and resists sudden changes.
          </T>
        </Box>
      </Reveal>
      ...
      <Reveal when={sub >= 2}>
        <Box color={C.purple} style={{ width: "100%" }}>
          ...
          <T color="#b8a9ff" size={17} style={{ marginTop: 12 }}>
            Track the squared gradient magnitude per parameter. Parameters with large gradients get smaller steps.
          ...
          >
            <T color={C.purple} bold size={17} style={{ fontFamily: "monospace" }}>
              v_t = 0.999 x v_(t-1) + 0.001 x g_t^2
            </T>
          </div>
          <T color="#b8a9ff" size={15} style={{ marginTop: 8 }}>
            Where beta_2 = 0.999. This tracks how "large" gradients typically are for this parameter.
          </T>
          <div style={{ display: "flex", gap: 14, marginTop: 16 }}>
            <div
              style={{
            ...
            >
              <T color="#ef9a9a" bold size={15} center>
                Large-gradient param
              </T>
              <T color={C.dim} size={14} style={{ marginTop: 8 }}>
                Gradients are often big (e.g., 50)
              </T>
              <T color={C.dim} size={14} style={{ marginTop: 4 }}>
                v is large (tracks 50^2 = 2500)
              </T>
              <T color={C.dim} size={14} style={{ marginTop: 4 }}>
                Divide by sqrt(v) = 50
              </T>
              <T color={C.red} bold size={14} style={{ marginTop: 6 }}>
                Effective step: SMALL
              </T>
            </div>
            <div
              style={{
            ...
            >
              <T color="#80e8a5" bold size={15} center>
                Small-gradient param
              </T>
              <T color={C.dim} size={14} style={{ marginTop: 8 }}>
                Gradients are tiny (e.g., 0.01)
              </T>
              <T color={C.dim} size={14} style={{ marginTop: 4 }}>
                v is small (tracks 0.01^2 = 0.0001)
              </T>
              <T color={C.dim} size={14} style={{ marginTop: 4 }}>
                Divide by sqrt(v) = 0.01
              </T>
              <T color={C.green} bold size={14} style={{ marginTop: 6 }}>
                Effective step: LARGE
              </T>
            </div>
          </div>
          <T color="#b8a9ff" size={16} style={{ marginTop: 12 }}>
            This automatically equalizes step sizes - parameters that need bigger steps get them, and parameters that
            need smaller steps are tamed.
          </T>
        </Box>
      </Reveal>
      ...
      <Reveal when={sub >= 3}>
        <Box color={C.green} style={{ width: "100%" }}>
          ...
          <T color="#80e8a5" size={17} style={{ marginTop: 12 }}>
            Both m and v start at zero. In the first few steps, they are biased toward zero because the running average
            has not had time to "warm up." Adam corrects this.
          </T>
          <div
            style={{
              padding: "14px",
          ...
          >
            <div style={{ display: "flex", flexDirection: "column", gap: 6, alignItems: "center" }}>
              <T color={C.green} bold size={17} style={{ fontFamily: "monospace" }}>
                m_hat = m_t / (1 - 0.9^t)
              </T>
              <T color={C.green} bold size={17} style={{ fontFamily: "monospace" }}>
                v_hat = v_t / (1 - 0.999^t)
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10, marginTop: 16 }}>
            ...
            >
              ...
              <T color={C.dim} size={14} style={{ marginTop: 4 }}>
                The correction is huge because m_1 only reflects 10% of the true mean.
              </T>
            </div>
            <div
              style={{
            ...
            >
              ...
              <T color={C.dim} size={14} style={{ marginTop: 4 }}>
                After many steps, 0.9^1000 is essentially 0. The correction disappears.
              </T>
            </div>
          </div>
        </Box>
      ...
      <Reveal when={sub >= 4}>
        <Box color={C.yellow} style={{ width: "100%" }}>
          ...
          >
            <T color={C.yellow} bold size={18} style={{ fontFamily: "monospace" }}>
              theta_new = theta - lr x m_hat / (sqrt(v_hat) + epsilon)
            </T>
          </div>
          <div style={{ marginTop: 14, display: "flex", flexDirection: "column", gap: 8 }}>
            {[
          ...
          >
            <T color="#ffe082" bold size={15}>
              Concrete example (t = 1):
            </T>
            <div style={{ display: "flex", flexDirection: "column", gap: 4, marginTop: 8 }}>
              <T color={C.dim} size={14}>
                theta = 0.5, gradient = 0.1, lr = 0.001
              </T>
              <T color={C.dim} size={14}>
                m_1 = 0.1 x 0.1 = 0.01, m_hat = 0.01 / 0.1 = 0.1
              </T>
              <T color={C.dim} size={14}>
                v_1 = 0.001 x 0.01 = 0.00001, v_hat = 0.00001 / 0.001 = 0.01
              </T>
              <T color={C.dim} size={14}>
                update = 0.001 x 0.1 / (sqrt(0.01) + 1e-8) = 0.001 x 0.1 / 0.1 = 0.001
              </T>
              <div style={{ display: "flex", alignItems: "center", gap: 6, marginTop: 4 }}>
      ...
      <Reveal when={sub >= 5}>
        <Box color={C.orange} style={{ width: "100%" }}>
          ...
          <T color="#ffb74d" size={17} style={{ marginTop: 12 }}>
            Weight decay is a technique that slightly shrinks all weights each step to prevent them from growing too
            large. Standard L2 regularization adds the decay to the gradient before Adam processes it. AdamW separates
            the two.
          </T>
          <div style={{ display: "flex", gap: 14, marginTop: 16 }}>
            <div
            ...
            >
              ...
              <T color={C.dim} size={14} style={{ marginTop: 8, fontFamily: "monospace" }}>
                g' = g + lambda x theta
              </T>
              <T color={C.dim} size={14} style={{ marginTop: 4 }}>
                Then feed g' into Adam.
              </T>
              <T color={C.red} size={14} style={{ marginTop: 8 }}>
                Problem: Adam's adaptive rates distort the weight decay. Parameters with large v get almost no decay.
              </T>
            </div>
            <div
              style={{
            ...
            >
              ...
              <T color={C.dim} size={14} style={{ marginTop: 8, fontFamily: "monospace" }}>
                theta = theta - lr x lambda x theta
              </T>
              <T color={C.dim} size={14} style={{ marginTop: 4 }}>
                Apply decay directly AFTER Adam step.
              </T>
              <T color={C.green} size={14} style={{ marginTop: 8 }}>
                Clean separation: Adam handles gradient direction, decay handles weight magnitude. No interference.
              </T>
            </div>
          </div>
          <div
          ...
          >
            <T color="#ffb74d" size={16}>
              GPT, BERT, LLaMA, and virtually all modern transformers use AdamW, not standard Adam. The decoupled weight
              decay was shown to improve generalization consistently.
            </T>
          </div>
        </Box>
      </Reveal>
