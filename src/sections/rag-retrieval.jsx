    ...
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
      ...
      <Reveal when={sub >= 5}>
        <Box color={C.pink} style={{ width: "100%" }}>
          ...
          <T color="#f5b7f8" center size={16} style={{ marginTop: 10 }}>
            The exact prompt you fire at the LLM. The placeholder in pink gets filled with the user&apos;s question.
            The LLM&apos;s response is the hypothetical answer that gets embedded.
          </T>
