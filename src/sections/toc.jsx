...
export const TOC = (ctx) => {
  ...
  const sections = [
    ...
    {
      num: 7,
      name: "Attention - The Full Computation",
      color: C.pink,
      desc: "Step-by-step math, multi-head, W_O, the complete picture",
    },
    { num: 8, name: "The Encoder", color: C.blue, desc: "Encoder architecture, Add & Norm, FFN, layer stacking" },
    {
      num: 9,
      name: "The Decoder",
      color: "#ef5350",
