...
export const FeedForwardNetwork = (ctx) => {
  const { sub, subBtnRipple, registerSubBtn, navigate } = ctx;
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
...
export const FFNParallelTrick = (ctx) => {
  const { sub, subBtnRipple, registerSubBtn, navigate } = ctx;
...
export const TransformerBlockRepeats = (ctx) => {
  const { sub, subBtnRipple, registerSubBtn, navigate } = ctx;
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
...
export const ResidualHighway = (ctx) => {
  const { sub, subBtnRipple, registerSubBtn, navigate } = ctx;
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
      ...
      {sub >= 0 && (
        <Box color={C.red} style={{ width: "100%" }}>
          ...
          <T color="#ef9a9a" size={16} style={{ marginTop: 6 }}>
            In chapter 1.15, we learned that gradients shrink as they travel backward through layers. During
        ...
        <Box color={C.purple} style={{ width: "100%" }}>
          ...
          >
            ...
            <T color="#b8a9ff" size={15} style={{ marginTop: 6 }}>
              ...
              (chapter 8.2). That means GPT-3's 96 blocks have <strong>192 gradient highways</strong> - one around every
              Attention layer and one around every FFN layer.
            </T>
...
export const PreNormVsPostNorm = (ctx) => {
  const { sub, subBtnRipple, registerSubBtn, navigate } = ctx;
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
...
export const BatchNormVsLayerNorm = (ctx) => {
  const { sub, subBtnRipple, registerSubBtn, navigate } = ctx;
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
